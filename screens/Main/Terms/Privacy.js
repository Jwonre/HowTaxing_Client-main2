...
2. 선택 수집 정보: (실물 상품 지급 시) 이름, 전화번호, 주소, (모바일 상품 지급 시) 전화번호 및 (제세공과금 처리 시) 이름, 주민등록번호, 전화번호, 주소, 이메일 주소
...
8. 개인정보 및 관심에 기반한 이용자 간 관계의 형성을 위한 경우
...
가. 세무사 및 법무사 등 전문가에게 세금 계산 및 중개서비스을 위하여 보유주택 정보 및 부동산 거래내역 등 세금계산에 필요한 정보을 제공
...
나. 「방문판매 등에 관한 법률」에 따른 전화권유판매자가 육성으로 수신자에게 개인정보의 수집 출처를 고지하고 전화 권유를 하는 경우
...
1. 회사는 이용자에게 개별적인 맞춤 서비스를 제공하기 위해 이용 정보를 저장하고 수시로 불러오는 개인정보 자동 수집 장치(이하 '쿠키’)를 사용합니다. 쿠키는 웹사이트를 운영하는데 이용되는 서버(http)가 이용자의 웹브라우저(pc 및 모바일을 포함)에게 보내는 소량의 정보이며 이용자의 저장공간에 저장되기도 합니다.
      ...
      <ButtonSection>
        <DropShadow
          ...
          <Button
            ...
            <ButtonText active={activeButton || agreePrivacy}>{buttonText}</ButtonText>
          </Button>
        </DropShadow>
      </ButtonSection>
    </Container>
