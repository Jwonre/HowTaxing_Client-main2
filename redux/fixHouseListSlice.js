...
export const fixHouseListSlice = createSlice({
  name: 'fixHouseList',
  initialState,
  reducers: {
    setFixHouseList: (state, action) => {
      state.value = action.payload;
    },
    editFixHouseList: (state, action) => {
...
export const { setFixHouseList, editFixHouseList } = fixHouseListSlice.actions;

export default fixHouseListSlice.reducer;
